...
pub struct State {
    ...
    pub diffuse_bind_group2: wgpu::BindGroup,
    pub group_switched: bool,
...
impl State {
    ...
    pub async fn new(window: Window) -> Self {
        ...
        let (device, queue) = adapter.request_device(
            &wgpu::DeviceDescriptor {
                ...
                limits: if cfg!(target_arch = "wasm32") {
                    ...
                    // The other limits error, presumably because pc bad
                    wgpu::Limits::downlevel_webgl2_defaults()
                },
                label: None,
            },
        ...
        let diffuse_bytes2 = include_bytes!("brot.png");
        let diffuse_texture2 = crate::texture::Texture::from_bytes(&device, &queue, diffuse_bytes2, "brot.png").unwrap();
        ...
        let group_switched = false;

        let reset_color = wgpu::Color {
            r: 0.1,
            g: 0.2,
            b: 0.3,
            a: 1.0,
    ...
    pub fn input(&mut self, event: &WindowEvent) -> bool {
        match event {
            ...
            WindowEvent::KeyboardInput {
                ...
                self.group_switched = !self.group_switched;
                self.window.request_redraw();
                true
            },
            _ => false,
...

        {
            let mut render_pass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
                ...
                color_attachments: &[Some(wgpu::RenderPassColorAttachment {
                    ...
                    resolve_target: None,
                    ops: wgpu::Operations {
                        load: wgpu::LoadOp::Clear(self.reset_color),
                        store: true,
                    },
                })],
